...
# MAGIC
# MAGIC The dataset we will be using is the IEEE's [*Transients and Faults in Power Transformers and Phase Angle Regulators* dataset](https://ieee-dataport.org/open-access/transients-and-faults-power-transformers-and-phase-angle-regulators-dataset).  The files that make up this dataset are generated using EMTDC/PSCAD and are provided in a simple, four-column delimited text format.
